---
title: "<img alt='webR logo' width='700px' src='webr-shiny.png'></img><br>Shiny Without a Server:<br>webR & Shinylive"
...
![](server-side.png){style="width:55%"}
...
![](client-side.png){style="width:55%"}

:::

## &nbsp; {background-image="ibm.jpg"}

## &nbsp; {background-image="phone.jpg"}
...
::: {.column width="40%"}
![](emcc.png){style="width:60%; margin-left: 20%"}
:::
...
![](pyodide.png){alt="The pyodide logo" height="350" fig-align="center"}
...
![](webr.png){alt="The webR logo" height="350" fig-align="center"}
...
::: {style="text-align: center"}
![](webr.gif){style="width: 80%; border: 1px solid #889; box-shadow: 2px 2px 15px #889;"}
:::
...
::: {style="text-align: center"}
![](standalone.png){style="width: 80%; border: 1px solid #889; box-shadow: 2px 2px 15px #889;"}
:::
...
::: {style="text-align: center"}
![](shinylive-editor.png){style="width: 90%; border: 1px solid #889; box-shadow: 2px 2px 15px #889;"}
:::

## Shinylive Online editor: Sharing apps

::: {style="text-align: center"}
![](share.png){style="width: 60%"}
:::
